...
<Accordion title="What is PartGenie?">
  ...
  **Core Features:**
  - AI search with verifiable citations (MPN, datasheet pages, web sources)
  - PartGenie Work — analyze & act on BOM/Design in chat
  - BOM health, engineering diff, estimated cost
  - Live multi-distributor sourcing & one-click purchase
  - Alternatives + exportable Alternative reports
  - Knowledge library, Design (Beta), Tariff lookup (Beta)
  - Android app; share chat & BOM by email
</Accordion>
...
<Accordion title="What can the BOM management tool do?">
  Full-process BOM workflow is available today:
  - Upload CSV/Excel or paste a part list; match lines to MPNs
  - Health report — distribution, EOL/NRND, sourcing gaps, bulk alternatives
  - Engineering **Changes** (Adopt & version history) and **estimated price**
  - Compare MPNs; chat with selected BOM lines as context via Work
  - Share BOM by email or link

  See [BOM management](/en-US/bom-management) and [PartGenie Work](/en-US/partgenie-work).
</Accordion>
